...
import static com.onnoeberhard.potato.ContactsAdapter.CONTACTS_PERMISSION;
import static com.onnoeberhard.potato.ContactsAdapter.ID_NULL;
import static com.onnoeberhard.potato.ContactsAdapter.ID_PHONES;
import static com.onnoeberhard.potato.ContactsAdapter.ID_STRANGER;
import static com.onnoeberhard.potato.SendPotatoActivity.STORAGE_PERMISSION;
    ...
    private void sendImage(final String name, boolean general) {
        try {
            ...
            if (dir.exists() || dir.mkdirs()) {
                ...
                out.close();
                Uri uri = FileProvider.getUriForFile(SendPeopleActivity.this, "com.onnoeberhard.potato.fileprovider", new File(file));
                if (uri != null) {
