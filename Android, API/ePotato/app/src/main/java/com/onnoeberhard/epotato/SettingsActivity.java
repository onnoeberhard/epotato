...
import com.onnoeberhard.epotato.inappbilling.Purchase;
...
import static com.onnoeberhard.epotato.EndpointsHandler.PR_STRANGERS;
import static com.onnoeberhard.epotato.LocalDatabaseHandler.DONATION;
                    ...
                    public boolean onPreferenceClick(Preference preference) {
                        ...
                        iabHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
                            ...
                            public void onIabSetupFinished(IabResult result) {
                                if (result.isSuccess()) {
                                    try {
                                        iabHelper.launchPurchaseFlow(getActivity(), sp.getBoolean(PREMIUM, false) ? DONATION : PREMIUM, 0, new IabHelper.OnIabPurchaseFinishedListener() {
                                            @Override
                                            public void onIabPurchaseFinished(IabResult result, Purchase info) {
                                                if (result.isSuccess() && info.getSku().equals(PREMIUM)) {
                                                ...
                                                } else if (result.isSuccess() && info.getSku().equals(DONATION)) {
